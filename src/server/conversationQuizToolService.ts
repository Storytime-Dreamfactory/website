...
export const runConversationQuizSkill = async (
  ...
  await appendConversationMessage({
    ...
    metadata: {
      ...
      learningGoalTopicGroup: learningGoal.topicGroup || undefined,
      quizGoal: learningGoal.sessionGoal || undefined,
      ...
      assessmentTargets: learningGoal.assessmentTargets,
      hintSequence: learningGoal.hintSequence,
      source: input.source,
    },
  })
